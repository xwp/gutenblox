...
* **Perform a [cursory search](https://github.com/xwp/gutenblox/issues)** to see if the enhancement has already been suggested.  If it has, add a comment to the existing issue instead of opening a new one.
